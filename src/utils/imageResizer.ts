...
// Error type constants for image processing classification
 ...
 */
export async function compressImageBuffer(imageBuffer: Buffer, maxBytes: number = IMAGE_TARGET_RAW_SIZE, originalMediaType?: string): Promise<CompressedImageResult> {
...
async function tryProgressiveResizing(context: ImageCompressionContext, sharp: SharpFunction): Promise<CompressedImageResult | null> {
...
async function tryPalettePNG(context: ImageCompressionContext, sharp: SharpFunction): Promise<CompressedImageResult | null> {
...
async function tryJPEGConversion(context: ImageCompressionContext, quality: number, sharp: SharpFunction): Promise<CompressedImageResult | null> {
...
async function createUltraCompressedJPEG(context: ImageCompressionContext, sharp: SharpFunction): Promise<CompressedImageResult> {
